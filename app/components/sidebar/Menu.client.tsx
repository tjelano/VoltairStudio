...
import { SettingsButton, HelpButton, ReferencesButton } from '~/components/ui/SettingsButton';
...
export const Menu = () => {
  ...
  return (
    <>
      <div
        style={{ width: collapsed ? '48px' : '340px' }}
        className={classNames(
          'flex selection-accent flex-col side-menu relative flex-shrink-0 h-full transition-[width] duration-200 text-sm',
          collapsed
            ? 'bg-transparent'
            : 'bg-white dark:bg-gray-950 border-r border-bolt-elements-borderColor shadow-sm',
      ...
      >
        <div
          className={classNames(
            ...
            collapsed
              ? 'justify-center'
              : 'justify-between border-b border-gray-100 dark:border-gray-800/50 bg-gray-50/50 dark:bg-gray-900/50',
          )}
        >
          <div className="flex items-center gap-2 text-bolt-elements-textPrimary">
            <button
              onClick={() => setCollapsed((value) => !value)}
              className="flex items-center justify-center w-6 h-6 shrink-0 bg-transparent border-none p-0"
              aria-label={collapsed ? 'Expand sidebar' : 'Collapse sidebar'}
              title={collapsed ? 'Expand sidebar' : 'Collapse sidebar'}
            >
              <div
                className={classNames('i-ph:sidebar-simple text-xl text-gray-500 dark:text-gray-400', {
          ...
          <>
            ...
            <div className="flex-1 flex flex-col min-h-0 w-full overflow-hidden">
              ...
              <div className="flex items-center justify-between border-t border-gray-200 dark:border-gray-800 px-4 py-3">
                <div className="flex items-center gap-3">
                  <ReferencesButton onClick={handleReferencesClick} />
